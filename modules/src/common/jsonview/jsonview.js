...
JSONFormatter = (function () {
	...
	JSONFormatter.prototype.decorateWithSpan = function (value, className) {
		var tip = className == "num" && value.toString().length == 13 ? '<i class="numTimeTip">' + this.htmlEncode($tools.dateFormat(value)) + '</i>' : ""
		return '<span class="' + className + '">' + this.htmlEncode(value) + "</span>" + tip;
	};
