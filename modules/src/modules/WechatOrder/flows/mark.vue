<template>
    <div class="timeline-panel wechat-order-apply" title="立案">
        ...
        <div class="info-group order-claim">
            ...
            <xui-input style="width:300px" :placeholder="`请输入${options.label}`" v-model="editValue" v-show="editting"></xui-input>
            <xui-button v-show="!editting" @click="edit()">修改</xui-button>
            <xui-button v-show="editting" @click="save()" color="success">{{options.ensureText}}</xui-button>
